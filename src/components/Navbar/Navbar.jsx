      ...
      <div className="bg-gradient-to-r from-dark to-secondary text-white font-montserrat">
        <div className="container py-[2px] sm:block hidden">
          <div className="flex items-center justify-between">
            ...
            <p className="text-sm">Numero Telefonico: 71315480</p>
          </div>
        </div>
      </div>
      <div className="container py-3 sm:py-0">
        <div className="flex justify-between items-center">
            ...
            <ul className="flex items-center gap-6">
              ...
              <li className="group relative cursor-pointer">
                <NavLink
                  ...
                  className={({ isActive }) =>
                    isActive
                      ? "text-blue-500 flex h-[72px] items-center gap-[2px]"
                      : "text-gray-500 flex h-[72px] items-center gap-[2px]"
                  }
                >
                  Servicios
                  <span>
          ...
          <div className="flex items-center gap-4">
            <button className="bg-gradient-to-r from-primary to-dark hover:from-dark hover:to-primary transition-all duration-500 text-white px-3 py-1 rounded-full font-montserrat">
              {" "}
              Login
            </button>
